...
@Component({
  selector: 'app-private-user-form',
  templateUrl: './private-user-form.component.html',
  styleUrls: ['./private-user-form.component.scss']
})
export class PrivateUserFormComponent implements OnInit {
  ...
  private setForm() {
    this.route.params.subscribe(params => {
      ...
      if (id && id2) {
        ...
        this.edit = true;
        this.create = false;
        this.formService.findFormDataSingle(id2).subscribe(form => {
  ...
  onUpdate() {
    ...
    this.formService.updateFormData(this.formDataId, object1)
      .subscribe(data => {
        // console.log(data);
  ...
  onSubmit() {
    ...
    object1['form_id'] = this.model._id;
    object1['data'] = this.model;
    this.formService.insertFormData(object1).subscribe(data => {
